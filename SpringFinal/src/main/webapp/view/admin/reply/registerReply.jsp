...
<div class="grid-container">
    ...
    <div class="grid-item" style="text-align: center">
        <form action="registerReply" method="post" enctype="multipart/form-data">
            <div style="text-align: left">
                <input type="hidden" name="id" value="${sessionScope.member.id}">
                <input type="hidden" name="board_category" value="reply">
                <label style="margin-left: 100px;">제목 :</label><br>
